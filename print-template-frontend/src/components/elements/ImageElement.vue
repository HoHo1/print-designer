<template>
  <div
    class="element-wrapper image-element"
  ...
  >
    <div class="element-content" :style="contentStyle">
      <img v-if="element.options.url" :src="element.options.url" :style="imageStyle" @error="handleError" />
...
const imageStyle = computed(() => ({
  width: '100%',
  height: '100%',
  objectFit: props.element.options.fit || 'contain'
}))
