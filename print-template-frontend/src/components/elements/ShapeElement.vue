<template>
  <div
    class="element-wrapper shape-element"
    :class="{ selected, locked, visible: !visible, [element.type]: true, preview }"
    :style="wrapperStyle"
    ...
    <div class="element-content" :style="contentStyle">
      <svg :width="element.width" :height="element.height">
        <rect
          ...
          :fill="element.options.fill || 'rgba(255,255,255,0)'"
          :stroke="element.options.stroke || '#000000'"
        ...
        <circle
          ...
          :cx="element.width / 2"
          :cy="element.height / 2"
          :r="Math.min(element.width, element.height) / 2 - strokeWidth / 2"
          :fill="element.options.fill || 'rgba(255,255,255,0)'"
          :stroke="element.options.stroke || '#000000'"
          :stroke-width="strokeWidth"
        />
...
const strokeWidth = computed(() => props.element.options.strokeWidth || 1)
